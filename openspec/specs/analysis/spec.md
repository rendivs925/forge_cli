...
Forge SHALL orchestrate configured analyzers and collect their results into a
unified analysis, executing independent analyzers concurrently within bounded
resources while isolating failures.
